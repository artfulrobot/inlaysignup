 ...
 */
class CRM_Inlaysignup_Upgrader_Base {

  /**
   * @var CRM_Inlaysignup_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Inlaysignup_Upgrader(
        'inlaysignup',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Inlaysignup_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Inlaysignup_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
