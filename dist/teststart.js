...
/* src/Test.svelte generated by Svelte v3.41.0 */


function add_css(target) {
  (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.append_styles)(target, "svelte-4sv8kz", "input{-webkit-appearance:none;-moz-appearance:none;appearance:none;color:#123456}div p{display:grid;transition:all 0.5s;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;background:linear-gradient(to bottom, white, black)}div progress::--progress-value{background-color:red}progress::-webkit-progress-value{background-color:#0162B7}progress::-webkit-progress-bar{background-color:#eee}progress::-moz-progress-bar{background-color:#0162B7;border:none}");
}
...
function create_fragment(ctx) {
  ...
  return {
    c: function c() {
      ...
      div.innerHTML = "<p><strong>x</strong><input type=\"text\"/></p> \n<progress></progress>";
    },
...
function instance($$self) {
  console.log("Test.svelte loaded");
  return [];
}
...
/*!**************************!*\
  ...
  \**************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Test_svelte__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Test.svelte */ "./src/Test.svelte");

new _Test_svelte__WEBPACK_IMPORTED_MODULE_0__.default({
